...
parser.on('data', function(data) {
    ...
    var humidite = data.slice(0, 4); //decoupe de la temperature
    var  temperature = data.slice(5, 10); //decoupe de l'humidite
...
//calcul de la date et l'heure 
    ...
    //fin test
//     if (/*(heur == 08 && min == 00 && sec == 00) || (heur == 12 && min == 00 && sec == 00) || (heur == 19 && min == 00 && sec == 00)*/sec==00) {
//         var tempe = parseFloat(temperature);
//         var humi = parseFloat(humidite);
...
app.get('', (req, res) => {
    ...
    MongoClient.connect(url, { useUnifiedTopology: true }, function(err, db) {
        ...
        // col.findOne(
        //     {},
        //     { sort: { _id: -1 } }, { Temperature: 1 }).toArray(function(err, tem1) {
        //         console.log(tem1);
        ...
        col.find({ Heure: "19:00:00" }, { Temperature: 1 }).toArray(function(err, tem2) {
            console.log(tem2);
